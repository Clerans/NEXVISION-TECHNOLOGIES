...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://nexvisiontech.com/disclaimer",
  },
};
    ...
    <SectionContainer size="narrow" className="py-16 md:py-24">
      ...
      <Card className="p-8 sm:p-12 bg-theme-surface border border-border-subtle space-y-8 text-theme-secondary leading-relaxed text-sm rounded-3xl">
        ...
        <div className="space-y-4 border-t border-border-subtle pt-6">
          <h2 className="text-xl font-bold text-theme-primary">2. No Binding Warranties</h2>
          <p>
        ...
        <div className="space-y-4 border-t border-border-subtle pt-6">
          <h2 className="text-xl font-bold text-theme-primary">3. Third-Party Trademarks</h2>
          <p>
